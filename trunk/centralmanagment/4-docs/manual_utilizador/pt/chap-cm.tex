...
\opt{etvm}{
    \begin{figure}[H]
    \begin{center}
    \includegraphics[scale=0.7]{screenshots/login_etvm.png}
...
O assistente de criação de datacenter possibilita a definição de novos \textit{clusters} de servidores. Cada datacenter possui as suas redes, e acesso aos volumes de armazenamento partilhados\footnote{Opção apenas disponível na versão \emph{ETVM}}.
