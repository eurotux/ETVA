...
\opt{etva}{
    ...
    Existem dois métodos para desligar a \textit{appliance ETVA}. O primeiro método é através da interface de gestão, seguindo os passos abaixo:
    ...
    \begin{figure}[H]
        ...
        \caption{Display disponível nas appliances ETVA}
