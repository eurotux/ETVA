...
%define httpd_mmn %(cat %{_includedir}/httpd/.mmn 2> /dev/null || echo missing-httpd-devel)
...
Patch22: php-5.2.10-pgmfree.patch
...
Group: Development/Languages
Requires: php-common = %{version}-%{release}, t1lib
...
for mod in pgsql mysql mysqli odbc ldap snmp xmlrpc imap \
    ...
    dbase mcrypt mhash tidy pdo_dblib mssql pspell curl wddx sqlite \
...
%changelog
* Mon Jun 22 2009 Andrew Thompson <andy@webtatic.com> 5.2.10-4
- update to 5.2.10
- removed fedora aclocal additions
