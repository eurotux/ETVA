...
if($argc<4){
 echo("Usage: virtClientCM_vgextend <host ip> <volume group name> <physical volumes>\n");
 echo("Example of usage: virtClientCM_vgextend 10.10.20.79 black /dev/sdb1,/dev/sdb2\n");
exit(0);
}
