 ...
 */
class EtvaServerMapBuilder implements MapBuilder {
	...
	{
		$this->dbMap = Propel::getDatabaseMap(EtvaServerPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(EtvaServerPeer::TABLE_NAME);
		...
		$tMap->addColumn('AGENT_PORT', 'AgentPort', 'INTEGER', false, null);

		$tMap->addColumn('AGENT_TMPL', 'AgentTmpl', 'VARCHAR', false, 255);
