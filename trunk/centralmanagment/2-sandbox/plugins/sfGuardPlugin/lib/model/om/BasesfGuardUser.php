...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
  ...
  const PEER = 'sfGuardUserPeer';
	...
	/**
	 * @var        array EtvaVncToken[] Collection to store aggregation of EtvaVncToken objects.
	 */
	protected $collEtvaVncTokens;

	/**
	 * @var        Criteria The criteria used to select the current contents of collEtvaVncTokens.
	 */
	private $lastEtvaVncTokenCriteria = null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collEtvaVncTokens = null;
			$this->lastEtvaVncTokenCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collEtvaVncTokens !== null) {
				foreach ($this->collEtvaVncTokens as $referrerFK) {
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getEtvaVncTokens() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addEtvaVncToken($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collEtvaVncTokens collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addEtvaVncTokens()
	 */
	public function clearEtvaVncTokens()
	{
		$this->collEtvaVncTokens = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collEtvaVncTokens collection (array).
	 *
	 * By default this just sets the collEtvaVncTokens collection to an empty array (like clearcollEtvaVncTokens());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initEtvaVncTokens()
	{
		$this->collEtvaVncTokens = array();
	}

	/**
	 * Gets an array of EtvaVncToken objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related EtvaVncTokens from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array EtvaVncToken[]
	 * @throws     PropelException
	 */
	public function getEtvaVncTokens($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collEtvaVncTokens === null) {
			if ($this->isNew()) {
			   $this->collEtvaVncTokens = array();
				...
				$criteria->add(EtvaVncTokenPeer::USER_ID, $this->id);

				EtvaVncTokenPeer::addSelectColumns($criteria);
				$this->collEtvaVncTokens = EtvaVncTokenPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				EtvaVncTokenPeer::addSelectColumns($criteria);
				if (!isset($this->lastEtvaVncTokenCriteria) || !$this->lastEtvaVncTokenCriteria->equals($criteria)) {
					$this->collEtvaVncTokens = EtvaVncTokenPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastEtvaVncTokenCriteria = $criteria;
		return $this->collEtvaVncTokens;
	}

	/**
	 * Returns the number of related EtvaVncToken objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related EtvaVncToken objects.
	 * @throws     PropelException
	 */
	public function countEtvaVncTokens(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collEtvaVncTokens === null) {
			if ($this->isNew()) {
				...
				$count = EtvaVncTokenPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastEtvaVncTokenCriteria) || !$this->lastEtvaVncTokenCriteria->equals($criteria)) {
					...
					$count = count($this->collEtvaVncTokens);
				}
			} else {
				$count = count($this->collEtvaVncTokens);
			}
	...
	/**
	 * Method called to associate a EtvaVncToken object to this object
	 * through the EtvaVncToken foreign key attribute.
	 *
	 * @param      EtvaVncToken $l EtvaVncToken
	 * @return     void
	 * @throws     PropelException
	 */
	public function addEtvaVncToken(EtvaVncToken $l)
	{
		if ($this->collEtvaVncTokens === null) {
			$this->initEtvaVncTokens();
		}
		if (!in_array($l, $this->collEtvaVncTokens, true)) { // only add it if the **same** object is not already associated
			array_push($this->collEtvaVncTokens, $l);
	...
	{
		if ($deep) {
			if ($this->collEtvaVncTokens) {
				foreach ((array) $this->collEtvaVncTokens as $o) {
