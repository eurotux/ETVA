...
Ext.override(Ext.form.ComboBox, {
    ...
    initList : function(){
        if(!this.list){
            ...
            // ADDED : reload parameter for placing a reload icon in list
            if(this.reload){
                if(!this.header){
            ...
            if(this.pageSize){
                ...
                this.footer = this.list.createChild({cls:cls+'-ft'});
                this.bbar.render(this.footer);                                                        
                this.pageTb = this.bbar;
                this.assetHeight += this.footer.getHeight();
            }
            ...
            */
            ...
            if(this.resizable){
                ...
                this[this.bbar?'footer':'innerList'].setStyle('margin-bottom', this.handleHeight+'px');
            }
        }
    }
