...
Ext.ns('Ext.ux.grid');   
  ...
  Ext.ux.grid.TotalCountBar = Ext.extend(Ext.Toolbar, {
     ...
     */
    displayMsg : 'Total of {2} record(s)',
    /**
     * @cfg {String} emptyMsg
...
Ext.ux.grid.RowExpander = Ext.extend(Ext.util.Observable, {
    ...
    getRowClass : function(record, rowIndex, p, ds){
        ...
        //TWEAKED didnt refresh data
        if(!content && (!this.lazyRender || this.state[record.id])){
...
Grid.util.RowMoveSelected = function (grid,direction) {
