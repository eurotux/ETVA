//
// BasicAuthHTTPSConnectSSLSocket.java implement as HTTPSConnectSSLSocket.java
...
class BasicAuthHTTPSConnectSSLSocket {

  /*public BasicAuthHTTPSConnectSSLSocket(String host, int port,
