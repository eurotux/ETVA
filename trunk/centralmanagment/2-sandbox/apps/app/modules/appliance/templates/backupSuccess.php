...
Appliance.Backup.Form = Ext.extend(Ext.form.FormPanel, {
    ...
    ,initComponent:function() {
        ...
        var config = {
            monitorValid:true,
            items:[
                {xtype:'displayfield',hideLabel:true,value: <?php echo json_encode(__('An appliance backup will save all ETVA settings. <br> If a virtual machine as an agent running, actual configuration/settings of that service will also be saved.<br><br>IT DOES NOT BACKUP DISK DATA!!! ONLY CURRENT CONFIGURATION!')) ?>}
                ,{
            ...
            failure:function(response){
                ...
                if(resp['action']==<?php echo json_encode(Appliance::MA_BACKUP) ?>)
                {
                    ...
                    Ext.MessageBox.show({
                        ...
                        msg: String.format(<?php echo json_encode(__('Could not perform ETVA BACKUP.<br> {0}')) ?>,resp['info']),
