...
<ul>
    <li><a href="#help-vlan-manage-add">Adicionar Redes</a></li>
    <li><a href="#help-vlan-manage-remove">Remover Redes</a></li>
...
<a id="help-vlan-manage-add"><h1>Adicionar Redes</h1></a>
...
<a id="help-vlan-mac"><h1>Gestão da pool de endereços MAC</h1></a>
<p>Em Gestão da <em>Pool de MACs</em> é possível criar a pool de endereços MAC. Para
além de adicionar MACs à pool, pode-se visualizar as redes associadas e os MACs ainda
disponíveis da pool.</p>
<a href="#help-vlan"><div>Início</div></a>
<hr/>

<a id="help-vlan-list"><h1>Listar de interfaces de rede</h1></a>
<p>É possível também listar as interfaces de uma rede, clicando sobre a rede pretendida.
    No painel abaixo aparecem as interfaces de rede que estão associadas.</p>
<a href="#help-vlan"><div>Início</div></a>
<hr/>
</div>
