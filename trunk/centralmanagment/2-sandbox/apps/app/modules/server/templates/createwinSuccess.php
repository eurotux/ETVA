...
<script>
    ...
    Ext.onReady(function(){
        ...
        var wizard = new Ext.ux.Wiz({
            border:true,
            title : 'New Virtual Server Wizard',
            ...
            cards : [
                ...
                new Ext.ux.Wiz.Card({
                    ...
                    items : [{
                            ...
                            html      : 'Welcome to the virtual server creatino wizard.<br>'+
                                'Follow the steps to configure a full capable server<br/><br/>'
                ...
                new Ext.ux.Wiz.Card({
                    ...
                    items : [{
                            ...
                            html      : 'Pleade entrer a name for the virtual server.'+
                        ...
                        new Ext.form.TextField({
                            name       : 'vm_name',
                            fieldLabel : 'New virtual server name',
                            emptyText : 'New name...',
                            invalidText : 'No spaces and special characters allowed!',
                            allowBlank : false,
                            validator  : function(v){
                                var t = /^[a-zA-Z_\-]+$/;
                                return t.test(v);
