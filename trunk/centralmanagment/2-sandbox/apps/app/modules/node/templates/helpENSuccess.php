<a id="ovf_import"><h1>Add Server Wizard</h1></a>
...
O assistente de importação OVF é constituido pelas seguintes etapas:<br /><br />
<ul>
    <li><b>Ficheiro OVF de origem -</b> Nesta etapa especifica-se o ficheiro OVF a importar.<br>
        O URL do ficheiro tem que estar acessível via endereço web para que o CM consiga importá-lo.
    </li>
...
<br><br>
        Caso o servidor de virtualização escolhido não possua memória disponível suficinete ou não suporte os drivers mencionados no OVF a importação não poderá ser efectuada.
    </li>
