...
<ul>
    ...
    <li><a href="#help-physical-vol-scan">Scan <em>physical volumes</em>.</a></li>
</ul>
...
<a id="help-physical-vol-scan"><h1>Scan <em><b>Physical Volumes</b></em></h1></a>
<p>On <em>Scan physical devices</em> it is possible to run a task on virtualization agent to lookup new disks and to register them on <em>Central Management</em>. 
It is also possible to unregister the physical device on <em>Central Management</em> to get it out of system management.</p>
<a href="#help-physical-vol"><div>Index</div></a>
<hr/>
