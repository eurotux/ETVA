...
//in this case it should be in service name=>main and will load js code from _DUMMY_main.php
...
DUMMY.View = function(config) {
    ...
    DUMMY.View.superclass.constructor.call(this, {
        activeTab:0,
...
Ext.extend(DUMMY.View, Ext.TabPanel,{
    /*
    ...
    buildItem:function(store){
        ...
        //load object from _DUMMY_main.php
        var main = new DUMMY.Main({service:services_ids['main']});        
