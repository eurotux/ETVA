...
<?php include_partial('ploneservice'); ?>
<script>
Ext.ns('ETASP.SERVER');
...
ETASP.View = function(config) {
    ...
    ETASP.View.superclass.constructor.call(this, {
        activeTab:0,
...
Ext.extend(ETASP.View, Ext.Panel,{
    /*
...
//        if(this.server['data']['plone']){
        // plone service tab
        var ploneservice = new Server.PloneService.Info({
//            title:<?php echo json_encode(__('ETASP')) ?>,
            server_id:this.server['id']
            ,service:services_ids['etasp_api']['id']
        });

        ploneservice.on('afterlayout',function(){
            ploneservice.loadRecord({
                id:this.server['id']
                ,service:services_ids['etasp_api']['id']
            });
        },this,{single:true});
...
//        var main = new ETASP.SERVER({server_id:server_id, service:services_ids['server']});
//        var mailbox = new ETASP.MAILBOX({server:this.server,service:services_ids['mailbox']});
//        var domain = new ETASP.DOMAIN({server:this.server,service:services_ids['domain'],maintab:this,mbtabidx:2});
//
...
//                }
//
//                var a = new ETASP.SERVER.Initiator({service_id: services_ids['server']['id']});
...
//ETASP.SERVER.space = Ext.extend(Ext.Panel,{
//    padding: '30 0 0 0',
//    layout:'column',
//    border:false,
...
//        ];
//
//        ETASP.SERVER.space.superclass.initComponent.call(this);
//    }
...
// REGISTAR UM XTYPE
//Ext.reg('server_space', ETASP.SERVER.space);
</script>
