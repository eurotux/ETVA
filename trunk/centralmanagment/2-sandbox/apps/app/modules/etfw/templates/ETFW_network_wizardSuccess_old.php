    ...
    Ext.onReady(function(){
        ...
        var vgcombo = new Ext.form.ComboBox({
            ...
            ,store:new Ext.data.JsonStore({
                ...
                ,url:<?php echo json_encode(url_for('volgroup/jsonListFree?nid=1'))?>
            })
        ...
        var fromVlans = new Ext.data.JsonStore({
            ...
            ,url:<?php echo json_encode(url_for('vlan/jsonList?nid=1'))?>});
...
//                    },
                    ...
                    items : [{
                            border    : false,
                            bodyStyle : 'background:none;padding-bottom:0px;',
...
//                                ,{
//isFormField:true ,fieldLabel:'',labelWidth:10
//                                    ,xtype:'box'
//                                    ,autoEl:{
// tag:'div', children:[{
// tag:'img'
