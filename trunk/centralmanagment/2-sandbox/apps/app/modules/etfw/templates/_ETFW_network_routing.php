<script>
     ...
     *
     */
    Ext.ns('ETFW_Network.Routing.ActiveRoutes');
    ETFW_Network.Routing.ActiveRoutes.Grid = Ext.extend(Ext.grid.GridPanel, {
        formCmp:null,
        initComponent:function() {
            ...
            var dataStore = new Ext.data.JsonStore({
                url: this.url,
                baseParams:{id:this.serviceId,method:'list_routes'},
                remoteSort: false,
                totalProperty: 'total',
                root: 'data',
            ...
            this.formCmp = Ext.getCmp(this.containerId+'-activeform');
            ...
            // call parent
            ETFW_Network.Routing.ActiveRoutes.Grid.superclass.initComponent.apply(this, arguments);
        ...
        deleteData : function (items) {
            ...
            conn.request({
                url: this.url,
                params:{id:this.serviceId,method:'delete_routes',params:Ext.encode(send_data)},
    ...
    Ext.reg('etfw_network_routing_activegrid', ETFW_Network.Routing.ActiveRoutes.Grid);

    // bottom panel
    ETFW_Network.Routing.CreateActiveForm = function(config) {

        Ext.QuickTips.init();
        Ext.form.Field.prototype.msgTarget = 'none';
        ...
        var intf_store = new Ext.data.JsonStore({
            ...
            baseParams:{id:this.serviceId,method:'boot_interfaces',mode:'boot_real_interfaces'},
            id: 'fullname',
            remoteSort: false,
            totalProperty: 'total',
            root: 'data',
        ...
        ETFW_Network.Routing.CreateActiveForm.superclass.constructor.call(this, {
            // baseCls: 'x-plain',
           // labelWidth: 90,
    ...
    Ext.extend(ETFW_Network.Routing.CreateActiveForm, Ext.form.FormPanel, {
        /*
         * build save button
         */
            ...
            return new Ext.Button({text: 'Save',
                handler: function() {
                    ...
                    if (this.form.isValid()) {
                        ...
                        conn.request({
                            url: this.url,
                            params:{id:this.serviceId,method:'create_route',params:Ext.encode(send_data)},
                            failure: function(resp,opt){
    ...
    Ext.ns('ETFW_Network.Routing.BootRoutes');

    ETFW_Network.Routing.BootRoutes.Grids = function(){
        return{

            init:function(parentContainerId,serviceId){
                   ...
                   // loadMask:true
                    ...
                    tbar: [
                        ...
                        {text: 'Refresh',
                            ...
                            scope:this,
                            handler: function(button,event){this.loadData(serviceId);}
                        }
                    ]
            ...
            loadData:function(serviceId){
                ...
                conn.request({
                        ...
                        params: {id:serviceId,method:'get_boot_routing'}
                        ,scope:this
                });
    ...
    ETFW_Network.Routing.BootRoutes.Form = function(config) {
        ...
        this.routes = ETFW_Network.Routing.BootRoutes.Grids;
        this.routes.init(this.id,this.serviceId);
        ...
        this.savebtn = new Ext.Button({text: 'Save',
            handler: function() {
                ...
                if (this.form.isValid()) {
                    ...
                    conn.request({
                        url: this.url,
                        params:{id:this.serviceId,method:'set_boot_routing',params:Ext.encode(submitData)},
                        failure: function(resp,opt){
                        ...
                        success: function(resp,opt){
                            ...
                            Ext.ux.Logger.info(msg);
                            View.notify({html:msg});
                            this.routes.loadData(this.serviceId);
        ...
        ETFW_Network.Routing.BootRoutes.Form.superclass.constructor.call(this, {
            // baseCls: 'x-plain',
            labelWidth: 90,
            url:<?php echo json_encode(url_for('etfw/json'))?>,
            defaultType: 'textfield',
    ...
    Ext.extend(ETFW_Network.Routing.BootRoutes.Form, Ext.form.FormPanel, {
   ...
   ETFW_Network.Routing.Main = function(serviceId,containerId) {

        var routingCreate = new ETFW_Network.Routing.CreateActiveForm({id:containerId+'-activeform',parent_id:containerId+'-activegrid',serviceId:serviceId});
        ...
        var bootroutes = new ETFW_Network.Routing.BootRoutes.Form({id:containerId+'-bootform',serviceId:serviceId});
        //
         ...
         ************************************************************/
        ETFW_Network.Routing.Main.superclass.constructor.call(this, {
    ...
    Ext.extend(ETFW_Network.Routing.Main, Ext.Panel, {
    });
