<script>
    ...
    ETFW_Firewall.Form_EqualCombo = function(config) {

        // call parent constructor
        ETFW_Firewall.Form_EqualCombo.superclass.constructor.call(this, config);
    ...
    // extend
    Ext.extend(ETFW_Firewall.Form_EqualCombo, Ext.form.ComboBox, {}); // end of extend


    // above/bellow combo
    ETFW_Firewall.Form_ABCombo = function(config) {

        // call parent constructor
        ETFW_Firewall.Form_ABCombo.superclass.constructor.call(this, config);
    ...
    // extend
    Ext.extend(ETFW_Firewall.Form_ABCombo, Ext.form.ComboBox, {}); // end of extend
    ...
    **/
    ...
    ETFW_Firewall.Form = Ext.extend(Ext.form.FormPanel, {
        ...
        ,initComponent:function() {
                       ...
                       // condition details fieldset
                       {
                        ...
                        items :[
                                //source address
                                {
                                 ...
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'s-c',hiddenName:'s-c',fieldLabel:'Source address or network'})]},
                                ...
                                // destination address
                                {
                                 ...
                                 layoutConfig: {columns: 2},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'d-c',hiddenName:'d-c',fieldLabel:'Destination address or network'})]},
                                ...
                                // incoming interface
                                {
                                 ...
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'i-c',hiddenName:'i-c',fieldLabel:'Incoming interface'})]},
                                ...
                                // outgoing interface
                                {
                                 ...
                                 layoutConfig: {columns: 3},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'o-c',hiddenName:'o-c',fieldLabel:'Outgoing interface'})]},
                                ...
                                // network protocol
                                {
                                 ...
                                 layoutConfig: {columns: 3},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'p-c',hiddenName:'p-c',fieldLabel:'Network protocol'})]},
                                ...
                                // Source TCP or UDP port
                                {
                                 ...
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'sport-c',hiddenName:'sport-c',fieldLabel:'Source TCP or UDP port'})]}
                                        ,{layout:'form',items:[{xtype:'radio', name:'sport-src', fieldLabel:'',hideLabel:true,boxLabel:'Port(s)',inputValue: ''}]}
                                        ,{layout:'form',items:[{xtype:'textfield',width:80,fieldLabel: '',hideLabel:true,name: 'sports'}]}
                                        ,{layout:'form',items:[{xtype:'radio', name:'sport-src', fieldLabel:'',hideLabel:true,boxLabel:'Port range',inputValue: 'range'}]}
                                ...
                                // Destination TCP or UDP port
                                {
                                 ...
                                 layoutConfig: {columns: 6},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'dport-c',hiddenName:'dport-c',fieldLabel:'Destination TCP or UDP port'})]}
                                        ,{layout:'form',items:[{xtype:'radio', name:'dport-src', fieldLabel:'',hideLabel:true,boxLabel:'Port(s)',inputValue: ''}]}
                                        ,{layout:'form',items:[{xtype:'textfield',width:80,fieldLabel: '',hideLabel:true,name: 'dports'}]}
                                        ,{layout:'form',items:[{xtype:'radio', name:'dport-src', fieldLabel:'',hideLabel:true,boxLabel:'Port range',inputValue: 'range'}]}
                                ...
                                // Source and destination port(s)
                                {
                                 ...
                                 layoutConfig: {columns: 2},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'ports-c',hiddenName:'ports-c',fieldLabel:'Source and destination port(s)'})]},
                                ...
                                // TCP flags set
                                {
                                 ...
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'tcp-flags-c',hiddenName:'tcp-flags-c',fieldLabel:'TCP flags set'})]}
                                ...
                                // TCP option number is set
                                {
                                 ...
                                 layoutConfig: {columns: 2},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'tcp-option-c',hiddenName:'tcp-option-c',fieldLabel:'TCP option number is set'})]},
                                ...
                                // ICMP packet type
                                {
                                 ...
                                 layoutConfig: {columns: 2},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'icmp-type-c',hiddenName:'icmp-type-c',fieldLabel:'ICMP packet type'})]},
                                ...
                                // Ethernet address
                                {
                                 ...
                                 layoutConfig: {columns: 2},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'mac-source-c',hiddenName:'mac-source-c',fieldLabel:'Ethernet address'})]},
                                ...
                                // Packet flow rate
                                {
                                 ...
                                 layoutConfig: {columns: 3},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_ABCombo({name:'limit-c',hiddenName:'limit-c',fieldLabel:'Packet flow rate'})]},
                                ...
                                // Packet burst rate
                                {
                                 ...
                                 layoutConfig: {columns: 2},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_ABCombo({name:'limit-burst-c',hiddenName:'limit-burst-c',fieldLabel:'Packet burst rate'})]},
                                ...
                                // Connection states
                                {
                                 ...
                                 layoutConfig: {columns: 2},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'state-c',hiddenName:'state-c',fieldLabel:'Connection states'})]},
                                         {layout:'form',items:[{
                                                            xtype:"multiselect",
                                                            fieldLabel:'',
                                                            hideLabel:true,
                                                            ...
                                                            height:100,
                                                            allowBlank:true,
                                                            data:[['New connection (NEW)','NEW'],['Existing connection (ESTABLISHED)','ESTABLISHED'],
                                                                  ['Related to existing (RELATED)','RELATED'],['Not part of any connection (INVALID)','INVALID'],
                                ...
                                // Type of service
                                {
                                 ...
                                 layoutConfig: {columns: 2},
                                 items: [
                                         {layout:'form',items:[new ETFW_Firewall.Form_EqualCombo({name:'tos-c',hiddenName:'tos-c',fieldLabel:'Type of service'})]},
            ...
            // call parent
            ETFW_Firewall.Form.superclass.initComponent.apply(this, arguments);
                        ...
                        items :[
                                ...
                                //reject with icmp type
                                {
                                 ...
                                 items: [
                                        ...
                                        {layout:'form',items:[{xtype:'radio', name:'reject-with-src', fieldLabel:'',hideLabel:true,boxLabel:'Type',inputValue: 'type'}]},
                                        {layout:'form',items:[{
                                                name:'reject-with'
        ...
        ,onRender:function() {
            // call parent
            ETFW_Firewall.Form.superclass.onRender.apply(this, arguments);
        ...
        ,onCreate:function(){
            ...
            conn.request({
                url: this.url,
                params:{id:this.serviceId,method:'add_rule',params:Ext.encode(send_data)},
        ...
        ,onSave:function() {
            ...
            var str='';
            for(prop in send_data)
                str+=prop+'->'+send_data[prop];
            ...
            conn.request({
                url: this.url,
                params:{id:this.serviceId,method:'set_rule',params:Ext.encode(send_data)},
                failure: function(resp,opt){
    ...
    ETFW_Firewall.Grid = Ext.extend(Ext.grid.GridPanel, {
        initComponent:function() {
                    ...
                    switch(action){
                          ...
                          case 'icon-down':
                           ...
                           case 'icon-top':
                                            ...
                                            var form = new ETFW_Firewall.Form({title:'daa',parent_grid:this,index:insert_at,reset:true});
            ...
            this.tbar = [{
                        ...
                        handler: function(){
                            ...
                            var form = new ETFW_Firewall.Form({title:'Add Rule',serviceId:this.serviceId,parent_grid:this,reset:true});
                            // create and show window
                            var win = new Ext.Window({
                       ...
                       '-',
                       {
                        ...
                        handler: function(){
                            ...
                            var form = new ETFW_Firewall.Form({title:'Edit Rule',serviceId:this.serviceId,parent_grid:this});
                            // create and show window
                            var win = new Ext.Window({
            ...
            // call parent
            ETFW_Firewall.Grid.superclass.initComponent.apply(this, arguments);
        ...
        ,moveRule:function(oldIndex,newIndex){
            ...
            conn.request({
                url: this.url,
                params:{id:this.serviceId,method:'move_rule',params:Ext.encode(send_data)},
                failure: function(resp,opt){
        ...
        delChain: function(){
            ...
            conn.request({
                url: this.url,
                params:{id:this.serviceId,method:'del_chain',params:Ext.encode(send_data)},
                failure: function(resp,opt){
        ...
        setPolicy: function(){
            ...
            conn.request({
                url: this.url,
                params:{id:this.serviceId,method:'set_policy',params:Ext.encode(send_data)},
                failure: function(resp,opt){
        ...
        deleteData:function(items){
            ...
            conn.request({
                url: this.url,
                params:{id:this.serviceId,method:'del_rules',params:Ext.encode(data)},
                failure: function(resp,opt){
                    var response = Ext.util.JSON.decode(resp.responseText);
                    Ext.MessageBox.alert('Error Message', response['info']);
                    Ext.ux.Logger.error(response['error']);
    ...
    Ext.reg('etfw_firewall_gridChain',ETFW_Firewall.Grid);



    ETFW_Firewall.Main = function(serviceId) {
        var table_panels = [];
        ...
        this.firewall_imgs['filter'] =
            {
                                ...
                                ,autoEl:{
                                    ...
                                    children:[
                                        ...
                                        {
                                         tag:'map'
                                         ,name:'etfw-firewall-rules-'+containerId+'-filter-imgmap'
                                         ,id:'etfw-firewall-rules-'+containerId+'-filter-imgmap'
                                         ,children:[
                                          {
                                              tag:'area'
                                              ,shape:'rect'
                                              ...
                                              ,coords:'14,98,62,112'
                                              ,chain:'etfw-firewall-rules-'+containerId+'-filter_INPUT'
                                              ,href:'#'
                                          },
                                          {
                                              tag:'area'
                                              ...
                                              ,chain:'etfw-firewall-rules-'+containerId+'-filter_OUTPUT'
                                              ,href:'#'
                                          }
                                         ]
                                        ...
                                        },
                                        {
                                            ...
                                            ,usemap:'#etfw-firewall-rules-'+containerId+'-filter-imgmap'
                                            ,style:'margin:10px 0px 10px 10px'}]
                                }
                                };

     //   this.firewall_imgs['mangle'] = {};
     //   this.firewall_imgs['nat'] = {};

        <?php if(empty($rules)): ?>
            View.notify({html:'Could not retrieve data from agent'});
            Ext.ux.Logger.error('Could not retrieve data from agent');
            Ext.MessageBox.show({
                        title: 'Error',
                        msg: '<center><b>The request could not be accomplished!</b></center><br>',
        ...
        // get each table
        foreach($rules as $table => $tabledata):
            ...
            var table_panel = 'etfw-firewall-rules-'+containerId+'-'+table;
            <?php

            foreach($tabledata as $chain => $chaindata): //get each table data

                $chaindata = (array) $chaindata;

                $rules = $chaindata['rules'];
                $chain_desc = $chaindata['chain_desc'];

                ?>
                var defaultData = <?php echo json_encode($rules); ?>;
                var grid_id = table_panel+'_'+<?php echo json_encode($chain); ?>;

                var grid = new ETFW_Firewall.Grid({
                                id:grid_id,
                                title:'<?php echo $chain_desc ?>',
                                collapsed:true,
                                //viewConfig: {forceFit: true},
                                url:this.url,
                                defaultAction:'<?php echo $chaindata['default'] ?>',
                                defaultData:defaultData,
                                layout:'fit',
                                serviceId:serviceId,
                                //  autoExpandColumn : 'condition',
                                // autoScroll:true,
                                baseParams:{id:serviceId,method:'list_rules',params:Ext.encode({"table":table,"chain":"<?php echo $chain ?>"})}});
                grids.push(grid);

                <?php

            endforeach; //end table data (chains info)
            ?>
            ...
            var top = [{
                    ...
                    items:[{xtype:'button',text:'Add new chain',handler:function(){
                                ...
                                var new_chain = Ext.getCmp(tab.id+'_newchain');

                                if(new_chain.isValid() && new_chain.getValue())
                                    this.addChain(tab.table,new_chain.getValue());
                                },scope:this},
                            {xtype:'textfield',id:table_panel+'_newchain',vtype: 'newchain'}]
                    }
                    ,table_img];
            ...
            var bottom = {
                    ...
                    items:[
                        ...
                        {layout:'table',layoutConfig: {columns: 3},
                            items: [
                               // applyBootBtn,
                                {xtype:'button',id:'<?php echo $table?>_activate_bootBtn',text:'Activate on boot',action:'',handler:this.applyConfiguration,style:'padding-right:5px;padding-bottom:10px;',scope:this},
                                {layout:'form',items:[{xtype:'radio', name:'boot_active', fieldLabel:'',listeners:{check:function(chkbox,isChecked){if(isChecked) Ext.getCmp('<?php echo $table?>_activate_bootBtn').action='activate_onboot';},scope:this},hideLabel:true,boxLabel:'Yes',inputValue: '1' <?php if($boot_active==1) echo ", checked:true" ?>}]},
                                {layout:'form',items:[{xtype:'radio', name:'boot_active', fieldLabel:'',listeners:{check:function(chkbox,isChecked){if(isChecked) Ext.getCmp('<?php echo $table?>_activate_bootBtn').action='deactivate_onboot';},scope:this},hideLabel:true,boxLabel:'No',inputValue: '0' <?php if($boot_active==0) echo ", checked:true" ?>}]}
                            ]
                        }]
            }; // end bottom panel


            table_panels.push({id:table_panel,table:table,autoScroll:true,title:'<?php echo $table_string ?>',bodyStyle: 'padding:0px 0px 0px 0px;',items:[top,
                                accordion_panel,bottom],
                                listeners:{
        ...
        <?php
        endforeach; //end tables for
        ?>

        ETFW_Firewall.Main.superclass.constructor.call(this, {
                                        stateEvents: ['tabchange'],
                                        activeTab: Ext.state.Manager.get('etfw-firewall-rules-'+containerId+'_active_tab', 0),
                                        listeners: {
                                                    'tabchange': function(){
                                                            Ext.state.Manager.set('etfw-firewall-rules-'+containerId+'_active_tab', this.getActiveTab().getId());
                                                    }
                                        },
                                        border:false,
    ...
    Ext.extend(ETFW_Firewall.Main, Ext.TabPanel,{
        addChain:function(table,chain){
            var send_data = {table:table,chain:chain};
            var tab = this.getActiveTab();
            var accordion_panel = Ext.getCmp(tab.id+'_accordion');
            ...
            conn.request({
                ...
                success: function(resp,opt){
                    ...
                    var newGrid = new ETFW_Firewall.Grid({title:'Chain '+chain,
                                    url: this.url,
                                    ...
                                    defaultData:defaultData,
                                    layout:'fit',
                                    baseParams:{id:this.serviceId,method:'list_rules',params:Ext.encode({"table":table,"chain":chain})}});
        ...
        applyConfiguration:function(b,e){
            ...
            conn.request({
                url: this.url,
                params:{id:this.serviceId,method:b.action},
                failure: function(resp,opt){
                ...
                success: function(resp,opt){
                    ...
                    if(b.action=='revert_config' || b.action=='reset_config' || b.action=='activate_onboot' || b.action=='deactivate_onboot'){
                        var updater = etfw_firewall_layout.getUpdater();
                        updater.refresh();
                    }
