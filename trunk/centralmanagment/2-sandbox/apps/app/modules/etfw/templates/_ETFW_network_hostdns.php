<script>
    ...
    Ext.ns('ETFW_Network.HostDns');


    ETFW_Network.HostDns.Form = function(serviceId) {
        ...
        ETFW_Network.HostDns.Form.superclass.constructor.call(this, {
            labelWidth: 90,
            autoScroll:true,
    ...
    Ext.extend(ETFW_Network.HostDns.Form, Ext.form.FormPanel, {
            ...
            return new Ext.Button({text: 'Save',
                ...
                handler: function() {
                    ...
                    if (this.form.isValid()) {
                        ...
                        conn.request({
                            url: this.url,
                            params:{id:this.serviceId,method:'set_hostname_dns',
        ...
        */
                        ...
                        items:[{
                               ...
                               ,{
                                 ...
                                 items:[{xtype:'radio', name:'search',
                                        ...
                                        {fieldLabel: '',xtype:'textarea',name:'domain'}]
                                }
                              ]
        ...
        loadData:function(){
                ...
                this.load({
                    url: this.url,
                    waitMsg:'Loading...',
                    params:{id:this.serviceId,method:'get_hostname_dns'},
    ...
    ETFW_Network.HostDns.Main = function(serviceId) {


        var form = new ETFW_Network.HostDns.Form(serviceId);
        ...
        ETFW_Network.HostDns.Main.superclass.constructor.call(this, {
            border:false,           
            layout:'fit',
    ...
    Ext.extend(ETFW_Network.HostDns.Main, Ext.Panel, {
    });
