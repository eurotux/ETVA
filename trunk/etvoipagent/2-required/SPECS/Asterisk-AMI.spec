...
#       --no-sign Asterisk-AMI-v0.2.4.tar.gz
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname Asterisk-AMI
%define filelist %{pkgname}-%{version}-filelist
%define NVR %{pkgname}-%{version}-%{release}
%define maketest 1

name:      perl-Asterisk-AMI
summary:   Asterisk-AMI - Perl module for interacting with the Asterisk Manager Interface
version:   v0.2.4
release:   1
vendor:    Ryan Bullock <rrb3942@gmail.com>
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    Asterisk-AMI-v0.2.4.tar.gz
...
%{__perl} -MFile::Find -le '
    ...
    print "%doc  Changes README LICENSE examples";
