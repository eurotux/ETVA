...
ETVA::Client::SOAP::HTTP - Module for soap client functions with HTTP protocol

=head1 SYNOPSIS

    my $Client = ETVA::Client::SOAP::HTTP->new( uri=>$uri );
...
=item new
    ...
    my $Client = ETVA::Client::SOAP::HTTP->new( method=>$method, proto=>$proto, address=>$addr, port=>$port );
...
L<ETVA::Client>, L<ETVA::Client::SOAP>, L<ETVA::Agent>
