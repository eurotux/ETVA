...
%define pkgname DNS-TinyDNS
%define filelist %{pkgname}-%{version}-filelist
%define NVR %{pkgname}-%{version}-%{release}
%define maketest 1

name:      perl-DNS-TinyDNS
summary:   DNS-TinyDNS - Perl extension for manipulating djbdns
version:   0.22
release:   1
vendor:    Anarion <anarion@7a69ezine.org>
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/A/AN/ANARION/DNS-TinyDNS-0.22.tar.gz
