...
if [ "$1" == "1" ]; then
    ...
    ( cd /tmp ; tar xvzf libvirt_certs.tar.gz libvirt_certs/; cd libvirt_certs; /bin/sh ./libvirt_cp_cert.sh; cd ..; rm -rf libvirt_certs; rm -f libvirt_certs.tar.gz ) >/dev/null 2>&1
