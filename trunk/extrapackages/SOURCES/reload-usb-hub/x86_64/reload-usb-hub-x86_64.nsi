...
; The file to write
OutFile "reload-usb-hub-x86_64.exe"

; The default installation directory
InstallDir $PROGRAMFILES64\reload-usb-hub
...
Function .onInit
  ...
  IntCmp $0 1 init64bits

  ; we are running on 64-bit windows
  
  Messagebox MB_OK|MB_ICONSTOP "Sorry, this installation package is for 64-bit Windows version only."
  Abort
